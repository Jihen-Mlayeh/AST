...
public class ModuleIdentifier {
    ...
    private final CouplingCalculator calculator;
    private final double CP; // Coupling threshold

    public ModuleIdentifier(CouplingCalculator calculator, double CP) {
    ...
    public List<List<String>> identifyModules() {
        ...
        // CORRECTION : Continuer tant que on peut fusionner ET qu'on dépasse M/2
    ...
    public static void main(String[] args) throws Exception {
        partie2.CallGraphAnalyzer analyzer = new partie2.CallGraphAnalyzer(
        ...
        ModuleIdentifier identifier = new ModuleIdentifier(calc, 0.1); // CP = 0.1
